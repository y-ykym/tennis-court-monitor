...
運用中の現状・設定値の所在・残 TODO は `docs/引き継ぎ_フェーズ2運用.md` が正。要件の履歴は `docs/予約空き監視_要件定義書.md`(§11 1.5 / §12 1.6 / §13 3 / §14 4)。
...
docs/予約空き監視_要件定義書.md  要件定義書(§11 1.5 / §12 1.6 / §13 フェーズ3 / §14 フェーズ4)
