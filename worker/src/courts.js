...
//   phone    : 公園のサービスセンター(管理所)の電話番号。フェーズ8 の「きゃんせる」で出す。
//              東京都公園協会「公園へ行こう!」の連絡先一覧(https://www.tokyo-park.or.jp/inquiry/list_park/)の
//              値をそのまま採用した(2026-09-24 確認)。番号が変わったらここだけ直す
//
...
export const COURTS = [
  ...
  { parkCode: '1040', name: '猿江恩賜公園', tbCodes: ['0100010008'], lat: 35.69048, lng: 139.81919, phone: '03-3631-9732' }, // 猿江恩賜公園
  { parkCode: '1050', name: '亀戸中央公園', tbCodes: ['0100010009'], lat: 35.70064, lng: 139.83786, phone: '03-3636-2558' }, // 亀戸中央公園
  { parkCode: '1160', name: '大島小松川公園', tbCodes: ['0100010020'], lat: 35.69144, lng: 139.84726, phone: '03-3636-9365' }, // 大島小松川公園Ａ
];
