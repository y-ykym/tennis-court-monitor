...
//     数百 m の座標のズレは結果に出ない
//   - 既定(best_match)は日本では気温・天気コードに気象庁のモデルを使い、降水確率だけ ECMWF の値になる
//     (2026-09-18 に models= で指定して実測・確認。気象庁のモデルは Open-Meteo では降水確率を返さない)。
//     どちらも生のモデル出力なので、テレビや気象庁サイトの発表値とは一致しない。要件 §16.2
//
